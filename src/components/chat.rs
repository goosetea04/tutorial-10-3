...
impl Component for Chat {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen h-screen bg-yellow-100">
                <div class="flex-none w-56 h-screen bg-gray-200 overflow-y-auto">
                    <div class="text-xl p-3 bg-yellow-200">{"Users"}</div>
                    {
                ...
                <div class="grow h-screen flex flex-col">
                    <div class="w-full h-14 border-b-2 border-gray-300 bg-yellow-200">
                        <div class="text-xl p-3">{"💬 Chat!"}</div>
                    </div>
                    <div class="w-full grow overflow-auto border-b-2 border-gray-300 bg-yellow-50">
                        {
                            self.messages.iter().map(|m| {
                                let user = self.users.iter().find(|u| u.name == m.from).unwrap();
                                html!{
                                    <div class="flex items-end w-3/6 bg-white m-8 rounded-tl-lg rounded-tr-lg rounded-br-lg shadow-md">
                    ...
                    <div class="w-full h-14 flex px-3 items-center bg-yellow-200">
